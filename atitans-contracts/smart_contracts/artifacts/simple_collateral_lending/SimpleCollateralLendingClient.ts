 ...
 */
export type SimpleCollateralLendingCreateCallParams =
  | Expand<AppClientBareCallParams & {method?: never} & {onComplete?: OnApplicationComplete.NoOpOC} & CreateSchema>
/**
 * Defines arguments required for the deploy method.
 */
export type SimpleCollateralLendingDeployParams = Expand<Omit<AppFactoryDeployParams, 'createParams' | 'updateParams' | 'deleteParams'> & {
  /**
   * Create transaction parameters to use if a create needs to be issued as part of deployment; use `method` to define ABI call (if available) or leave out for a bare call (if available)
   */
  createParams?: SimpleCollateralLendingCreateCallParams
}>
...
/**
 * A factory to create and deploy one or more instance of the SimpleCollateralLending smart contract and to create one or more app clients to interact with those (or other) app instances
 */
export class SimpleCollateralLendingFactory {
  /**
  ...
  /**
   * Creates a new instance of `SimpleCollateralLendingFactory`
   *
  ...
  public getAppClientById(params: AppFactoryAppClientParams) {
    return new SimpleCollateralLendingClient(this.appFactory.getAppClientById(params))
  }
  ...
  public async getAppClientByCreatorAndName(
    ...
    return new SimpleCollateralLendingClient(await this.appFactory.getAppClientByCreatorAndName(params))
  }

  /**
   * Idempotently deploys the SimpleCollateralLending smart contract.
   *
   * @param params The arguments for the contract calls and any additional parameters for the call
   * @returns The deployment result
   */
  public async deploy(params: SimpleCollateralLendingDeployParams = {}) {
    const result = await this.appFactory.deploy({
      ...params,
    })
    return { result: result.result, appClient: new SimpleCollateralLendingClient(result.appClient) }
  }
  ...
  readonly params = {
    ...
    create: {
      /**
       * Creates a new instance of the SimpleCollateralLending smart contract using a bare call.
       *
